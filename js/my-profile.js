document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateImage() {
    if (inputPicture.files && inputPicture.files[0]) { // verifica si hay archivos seleccionados
      const reader = new FileReader(); // el objeto FileReader lee archivos y accede a su contenido

      reader.onload = function (e) { // controlador para el evento load, cuando se completa la carga, se actualiza
